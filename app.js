...
import resLogo from "./images/meghanaFoods.jpeg"
    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src={myImage}></img>
            </div>
...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card">
            <img
                className="res-logo" alt="res-logo" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"}></img>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
